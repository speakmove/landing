/**
 * Telegram-style doodle wallpaper SVG (28 hand-drawn glyphs).
 * Always full-bleed background of the chat area, decorative only.
 */
export const DoodleWallpaper = () => {
  return (
    <svg
      className="doodle-wallpaper pointer-events-none absolute inset-0 h-full w-full select-none"
      viewBox="0 0 360 720"
