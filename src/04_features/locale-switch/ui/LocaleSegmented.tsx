...
/**
 * Segmented pill locale switcher — used in the mobile slide-in menu.
 * Desktop header uses the dropdown variant (`LocaleSwitch`).
 */
export const LocaleSegmented = ({ size = 'md' }: TProps) => {
