...
10) const isExternal = (href: string): boolean => {
  ...
  12) не все ariaLabelledBy имею передемеднный текст

11) Advantages tiles на HomePage нужно решить

12) также лого , которое полное, у тебя обрезано последная буква 